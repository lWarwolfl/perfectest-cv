...
import { LETTER_TEMPLATES } from '@/features/resume/templates'
...
export function LetterTemplatePickerDialog({
  open,
  onOpenChange,
  pendingId,
  onPick,
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-lg">
        <DialogHeader>
          ...
          <DialogDescription>
            Your cover letter comes prefilled with sample content you can replace with your own.
          </DialogDescription>
        </DialogHeader>
          ...
          {templates.map((t) => (
            ...
            >
              ...
              <Button
                ...
                disabled={!!pendingId}
                onClick={() => onPick(t.id)}
                aria-label={`Create a cover letter from the ${t.name} template`}
              >
