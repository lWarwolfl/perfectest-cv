...
export const Letter = pgTable(
  'letter',
  {
    ...
    senderEmailLink: text('sender_email_link').notNull().default(''),
    senderPhone: text('sender_phone').notNull().default(''),
    senderPhoneLink: text('sender_phone_link').notNull().default(''),
    senderAddress: text('sender_address').notNull().default(''),
    senderWebsite: text('sender_website').notNull().default(''),
    senderWebsiteLink: text('sender_website_link').notNull().default(''),
    senderLinkedIn: text('sender_linked_in').notNull().default(''),
    senderLinkedInLink: text('sender_linked_in_link').notNull().default(''),
    senderGitHub: text('sender_git_hub').notNull().default(''),
    senderGitHubLink: text('sender_git_hub_link').notNull().default(''),
